...
use super::super::types::main_order_types::{Order, OrderTotals, OrderSource};
use super::super::types::order_types::{OrderLineItem, PaymentTransaction, Shipment, OrderNote, OrderHistoryEvent, TransactionStatus, TransactionType, OrderEventType};
...
use crate::implementation::cart_system::{Cart, ShippingMethod};
    ...
    impl Order {
        ...
        pub fn add_shipment(&mut self, shipment: Shipment) {
            ...
            self.add_history_event(OrderEventType::Shipped, format!("Shipment {} created", shipment.id), None);
